...
export default async function BusinessPage({ params }: Params) {
  ...
  const [hours, menu, reviews] = await Promise.all([
    getHours(b.id),
    getMenu(b.id),
  ...
  return (
    <div className="container-shell py-8">
      ...
      {/* Hero banner */}
      <div className="relative mt-4 overflow-hidden rounded-2xl bg-sign-navy px-6 py-8 shadow-raised sm:px-10 sm:py-10">
        <Icon
        ...
        <div className="relative">
          ...
          {b.tagline && <p className="mt-2 max-w-2xl text-cream/85">{b.tagline}</p>}
